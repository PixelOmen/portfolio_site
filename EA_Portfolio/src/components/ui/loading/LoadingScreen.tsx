...
export default function AppLoading( { className = "" }: AppLoadingProps ) {
  ...
  return (
    ...
    >
      ...
      <div className={`h-5 w-64 border-4 border-gray-900 rounded-lg bg-gray-400 ${styles.loadingBarContainer}`}>
        <div className={`h-full w-0 bg-[#05a548] rounded-lg ${styles.loadingBar}`}></div>
      </div>

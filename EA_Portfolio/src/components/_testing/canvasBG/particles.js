...
class ParticleEngine {
	...
	constructor(canvas_elem) {
		...
		this.stage = new Stage(canvas_elem.id);
		this.canvas_elem = canvas_elem;
		this.totalWidth = this.canvasWidth = canvas_elem.width;
		this.totalHeight = this.canvasHeight = canvas_elem.height;
	...
	resize() {
		this.totalWidth = this.canvasWidth = this.canvas_elem.width;
		this.totalHeight = this.canvasHeight = this.canvas_elem.height;
		this.render();
